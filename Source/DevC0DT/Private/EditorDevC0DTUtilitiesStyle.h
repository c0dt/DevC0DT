...
class FEditorDevC0DTUtilitiesStyle final
	: public FSlateStyleSet
{
public:
	FEditorDevC0DTUtilitiesStyle()
		: FSlateStyleSet("EditorDevC0DTUtilitiesStyle")
	{
		...
		SetContentRoot(FPaths::ProjectPluginsDir() / TEXT("/DevC0DT/Content/Slate"));
		...
		Set("Icons.MainIcon.StatusBar", new IMAGE_BRUSH_SVG("gamepad-svgrepo-com", Icon16x16));
	...
	static FEditorDevC0DTUtilitiesStyle& Get()
	{
		static FEditorDevC0DTUtilitiesStyle Inst;
		return Inst;
	}
